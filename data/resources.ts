...
export const resources: Resource[] = [
      // 1. Sci-fi Rooms and Corridors Interior Kit
    {
      id: "Sci-fi-Rooms-and-Corridors-Interior-Kit",
      title: "科幻房间与走廊室内套件",
      description: "以轨道飞船为主题的科幻室内环境套件,专注于未来环境中的居住和休闲区域的房间与走廊。包含房间、走廊、道具和贴花,可创建具有PBR材质的逼真几何结构。AAA游戏品质环境,完全PBR材质,一组硬表面贴花可增加表面视觉变化。包含114个网格体（含55个贴花网格体）、41个材质和材质实例、92张纹理（4096x4096和2048x2048——反照率、法线、金属度、AO、粗糙度）。包含碰撞体（自定义或自动生成）和需要的LOD。支持Windows、macOS、Linux、PS4、Xbox One、Oculus、SteamVR/HTC Vive平台。",
      category: "environments",
      tags: ["科幻", "室内", "走廊", "太空飞船", "模块化", "PBR", "房间"],
      images: [
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmWS9ysR8t9Ny3jbQRytmg6LpHxMwpoKvdk96nGpzwTi2a/1.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmWS9ysR8t9Ny3jbQRytmg6LpHxMwpoKvdk96nGpzwTi2a/2.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmWS9ysR8t9Ny3jbQRytmg6LpHxMwpoKvdk96nGpzwTi2a/3.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmWS9ysR8t9Ny3jbQRytmg6LpHxMwpoKvdk96nGpzwTi2a/4.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmWS9ysR8t9Ny3jbQRytmg6LpHxMwpoKvdk96nGpzwTi2a/5.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmWS9ysR8t9Ny3jbQRytmg6LpHxMwpoKvdk96nGpzwTi2a/6.jpg",
      ],
    ...
    // 2. Afghan Village Environment
    {
      id: "Afghan-Village-Environment",
      title: "阿富汗村庄环境",
      description: "由Leartes Studios制作的高品质阿富汗村庄环境资源包,包含255个独特网格体,具有良好的细节水平,针对游戏项目进行了优化。适合填充游戏环境或虚拟制作关卡。包含预组装场景、演示地图和终极关卡美术工具(ULAT)。支持UE5.0+的Nanite和Lumen。包含98个材质和材质实例、215张纹理。纹理尺寸涵盖4096、2048和1024。所有复杂资产均有自定义碰撞体和4级LOD。需要启用HDRI插件。",
      category: "environments",
      tags: ["阿富汗", "村庄", "中东", "环境", "Nanite", "Lumen", "写实"],
      images: [
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmW9Rxn31rRMfoTeebZXWbYsXr9ygzDEXncCM8YGmsWPPA/1.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmW9Rxn31rRMfoTeebZXWbYsXr9ygzDEXncCM8YGmsWPPA/2.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmW9Rxn31rRMfoTeebZXWbYsXr9ygzDEXncCM8YGmsWPPA/3.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmW9Rxn31rRMfoTeebZXWbYsXr9ygzDEXncCM8YGmsWPPA/4.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmW9Rxn31rRMfoTeebZXWbYsXr9ygzDEXncCM8YGmsWPPA/5.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmW9Rxn31rRMfoTeebZXWbYsXr9ygzDEXncCM8YGmsWPPA/6.jpg",
      ],
    ...
    // 3. Old Style Pharmacist Laboratory
    {
      id: "Old-Style-Pharmacist-Laboratory",
      title: "老式药剂师实验室",
      description: "与药剂师合作创建,基于他们的记忆和照片制作。包含网格体和材质,可创建存在于药房、化学品商店和大学中的旧式实验室。设计为全新整洁的外观,但模型也可用于巫术、炼金术或药水制作场景。包含129个网格体、85个材质、117张纹理（512x512至4096x4096）。资产包括:书架、书籍和羊皮纸、工作台、旧秤、药剂师罐、研钵和研杵、人类头骨模型、开放式烹饪区和烤箱、水盆和玻璃器皿干燥架、实验室玻璃器皿（滴定管、量筒、烧瓶、试管）、2种玻璃材质、1种半透明液体材质、简单建筑部件和2个示例实验室。",
      category: "environments",
      tags: ["实验室", "药剂师", "复古", "室内", "炼金术", "玻璃器皿", "道具"],
      images: [
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmcvtZgDgjtP8Zj4B3trkTpC4XiVB9iUSfb4qEP4KAsAMw/1.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmcvtZgDgjtP8Zj4B3trkTpC4XiVB9iUSfb4qEP4KAsAMw/2.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmcvtZgDgjtP8Zj4B3trkTpC4XiVB9iUSfb4qEP4KAsAMw/3.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmcvtZgDgjtP8Zj4B3trkTpC4XiVB9iUSfb4qEP4KAsAMw/4.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmcvtZgDgjtP8Zj4B3trkTpC4XiVB9iUSfb4qEP4KAsAMw/5.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmcvtZgDgjtP8Zj4B3trkTpC4XiVB9iUSfb4qEP4KAsAMw/6.jpg",
      ],
    ...
    // 4. 2 in 1 Nanite Environment Bundle 1
    {
      id: "2-in-1-Nanite-Environment-Bundle-1",
      title: "二合一Nanite环境合集1",
      description: "由Dazzling Divine制作的合集包,结合两个环境包:(1)令人惊叹的自然场景——高多边形Nanite树木、草地、灌木、岩石、悬崖和远山,营造郁郁葱葱的景观;(2)火山环境——高度精细的火山、悬崖、粗糙岩石、地形和动态Alembic熔岩流,配有VDB喷发效果。专为影视级渲染和高端游戏设计,呈现最高细节水平。VDB体积效果为静态几何缓存（非交互式粒子系统）,需要UE5.3+。包含68个独特网格体、92个材质和材质实例、146张纹理（最高8K分辨率）。顶点数100万+,包含碰撞体,无LOD。",
      category: "environments",
      tags: ["Nanite", "自然环境", "火山", "高多边形", "影视级", "熔岩", "VDB", "景观"],
      images: [
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmVBHpkLn5iHpzoqbYVGsms4M9HRegwgzWYmhpWUfmJBA4/1.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmVBHpkLn5iHpzoqbYVGsms4M9HRegwgzWYmhpWUfmJBA4/2.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmVBHpkLn5iHpzoqbYVGsms4M9HRegwgzWYmhpWUfmJBA4/3.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmVBHpkLn5iHpzoqbYVGsms4M9HRegwgzWYmhpWUfmJBA4/4.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmVBHpkLn5iHpzoqbYVGsms4M9HRegwgzWYmhpWUfmJBA4/5.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmVBHpkLn5iHpzoqbYVGsms4M9HRegwgzWYmhpWUfmJBA4/6.jpg",
      ],
    ...
    // 5. Alien Planet Pack
    {
      ...
      title: "外星星球资源包",
      description: "一个低多边形环境包,包含4个生物群落,非常适合低性能移动游戏和风格化的PC/主机游戏。包括沙漠、雪地、热带和气体4个生物群落。每个生物群落包含10-20个岩石网格体、10-14个植被网格体、4个地形材质和天气粒子。还包含11个模块化古代外星结构（每个2种材质类型）、4艘飞船（每艘3种材质类型）、用于循环飞船路径的蓝图样条线系统,以及自动跟随活动摄像机的天气粒子蓝图。包含158个独特网格体、25个材质和材质实例、15张纹理。天气粒子:气体羽流、雪、雨、灰尘、发光微粒。",
      category: "environments",
      tags: ["外星", "星球", "低多边形", "风格化", "移动端", "科幻", "生物群落"],
      images: [
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmSFxDiMWCxmT3ogZsGHZXPtoXsjqsDqwW2J2ZfajRqvvZ/1.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmSFxDiMWCxmT3ogZsGHZXPtoXsjqsDqwW2J2ZfajRqvvZ/2.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmSFxDiMWCxmT3ogZsGHZXPtoXsjqsDqwW2J2ZfajRqvvZ/3.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmSFxDiMWCxmT3ogZsGHZXPtoXsjqsDqwW2J2ZfajRqvvZ/4.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmSFxDiMWCxmT3ogZsGHZXPtoXsjqsDqwW2J2ZfajRqvvZ/5.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmSFxDiMWCxmT3ogZsGHZXPtoXsjqsDqwW2J2ZfajRqvvZ/6.jpg",
      ],
    ...
    // 6. Modular Sci-Fi Base - Indoor Outdoor - Mars Theme
    {
      id: "Modular-Sci-Fi-Base-Indoor-Outdoor-Mars-Theme",
      title: "模块化科幻基地-室内外-火星主题",
      description: "一个高多边形科幻模块化套件,用于构建您自己的科幻基地,可获得影视级效果,非常适合逼真的场景构图和沉浸式游戏体验。网格体在Base10网格上实现模块化。所有网格体均启用Nanite,沿整个边缘建模了2个倒角以实现正确的光照行为。使用智能材质纹理化,支持3个重叠层,并带有可自定义的遮罩。包含486个高多边形网格体（483个独特）、106个材质和材质实例（3个主材质、2个函数、101个实例）、521张纹理。",
      category: "environments",
      tags: ["科幻", "模块化", "火星", "基地", "Nanite", "高多边形", "室内外", "影视级"],
      images: [
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmQ9V13sSC6ZjKQgktLvoUpi6rmwf77VPhLsKqogqN2urU/1.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmQ9V13sSC6ZjKQgktLvoUpi6rmwf77VPhLsKqogqN2urU/2.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmQ9V13sSC6ZjKQgktLvoUpi6rmwf77VPhLsKqogqN2urU/3.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmQ9V13sSC6ZjKQgktLvoUpi6rmwf77VPhLsKqogqN2urU/4.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmQ9V13sSC6ZjKQgktLvoUpi6rmwf77VPhLsKqogqN2urU/5.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmQ9V13sSC6ZjKQgktLvoUpi6rmwf77VPhLsKqogqN2urU/6.jpg",
      ],
      downloadUrl: "https://pan.baidu.com/s/10CeHfHdj2aS6P3pmusC2dQ?pwd=1k6y",
      demoUrl: "https://www.fab.com/listings/bd034245-3d8c-477d-b74a-868ad0bae5a5",
      version: "1.0",
      ueVersion: "5.0 - 5.5",
      fileSize: "12.29 GB",
      createdAt: "2026-04-01",
    ...
    // 7. Abandoned Cathedral
    {
      id: "Abandoned-Cathedral",
      title: "废弃大教堂",
      description: "由RagTarock制作的游戏就绪模块化资源包,用于创建废弃的CG大教堂及其周围环境,适合恐怖游戏或影视特效项目。特色包括模块化建筑网格体、室内家具（书架、桌子）以及一组扭曲的3D树木和灌木。包含一个带有影视级灯光的完成演示地图。支持Nanite,默认启用Lumen。包含210个网格体、5个主材质、79个材质实例、249张纹理（最大分辨率4096x4096）。涵盖模块化建筑部件、室内家具和室外植被。",
      category: "environments",
      tags: ["教堂", "废弃", "恐怖", "模块化", "Nanite", "Lumen", "哥特", "建筑"],
      images: [
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmQQFEumjgMKpzhkYCPVwfWn9hiVJy2nryVnLDCmK6TxTF/1.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmQQFEumjgMKpzhkYCPVwfWn9hiVJy2nryVnLDCmK6TxTF/2.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmQQFEumjgMKpzhkYCPVwfWn9hiVJy2nryVnLDCmK6TxTF/3.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmQQFEumjgMKpzhkYCPVwfWn9hiVJy2nryVnLDCmK6TxTF/4.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmQQFEumjgMKpzhkYCPVwfWn9hiVJy2nryVnLDCmK6TxTF/5.jpg",
        "https://tomato-total-lark-322.mypinata.cloud/ipfs/QmQQFEumjgMKpzhkYCPVwfWn9hiVJy2nryVnLDCmK6TxTF/6.jpg",
      ],
