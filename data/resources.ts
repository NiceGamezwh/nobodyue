...
export const resources: Resource[] = [
  ...
  模块化的,用户可以轻松修改,所有组件都经过精心设计,能够完美地组合在一起。评分4.4/5,适合科幻类游戏和影视项目使用。",
    ...
    // 6. Suburbs - City Pack
    {
      ...
      title: "郊区-城市资源包",
      description:"这个资源包拥有你创建大型郊区/住宅区/社区/城镇区域所需的一切,可以快速且轻松地构建城市场景！工具/蓝图具有直观的UI、详细的文档和全方位的艺术控制。包含大量3D模型、材质、蓝图和其他资产,让你的工作更加轻松,节省数百小时的工作量。你可以非常轻松地自定义几乎所有材质。区域基于纽约市——布鲁克林、布朗克斯、曼哈顿及周边地区的住宅区。包含17个主材质（非常容易自定义）、442个材质实例、4个材质参数集合和2个材质函数。蓝图涵盖道路、人行道、屋顶/地板、交通灯、贴花、横幅、背景建筑、模块化建筑、围栏和电线。最新更新支持Nanite和Lumen优化。
  ",
      category: "environments",
